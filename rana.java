...
public class rana extends mohid {
...
public static void main(String[] args) {
         ...
         * if(user.equalsIgnoreCase(food[row1][0]) &&
         * user2.equalsIgnoreCase(food[row1][1])){
         * ip += food[row1][2];
         * }
         * }
         */
...
public static String ipLocationRes(String user) throws Exception {
        ...
        String ip = "";
        int temp1 = mohid.get_lines("restauraunt_login_data.txt") / 4;
